...
namespace agg
{
    ...
    template<int I1, int I3>
    class color_conv_rgb24_rgb48
    {
    public:
        void operator ()(int8u * dst,
            const int8u * src,
    ...
    class color_conv_rgba64_rgba32
    {
    public:
        void operator ()(int8u * dst,
            const int8u * src,
