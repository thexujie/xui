...
namespace graphics
{
    ...
    public:
        ...
        virtual core::math::si32i size() const = 0;
    ...
    public:
        ...
        virtual void PushOrign(core::math::pt32i point) = 0;
        virtual core::math::pt32i GetOrign() const = 0;
        virtual void PopOrign() = 0;
        virtual void PushClip(core::math::rc32i rect) = 0;
        virtual core::math::rc32i GetClip() const = 0;
        virtual void PopClip() = 0;

        virtual void Clear(core::color32 color) = 0;

        virtual void DrawString(std::string str, core::math::pt32i point, graphics::text::font font, core::color32 color) = 0;

        virtual void DrawImage(const graphics::IGraphicsImage & image, core::math::pt32i point) = 0;
        virtual void DrawImage(const graphics::IGraphicsImage & image, core::math::pt32i point, core::math::rc32i region) = 0;
        virtual void DrawImage(const graphics::IGraphicsImage & image, core::math::rc32i rect) = 0;
        virtual void DrawImage(const graphics::IGraphicsImage & image, core::math::rc32i rect, core::math::rc32i region) = 0;


        virtual void DrawString(const std::string & str, core::math::pt32i point, const text::font & font, core::color32 color, int32_t flags) = 0;
        virtual void DrawString(const std::string & str, core::math::rc32i rect, const text::font & font, core::color32 color, int32_t flags) = 0;
        ...
        virtual void DrawString(graphics::IGraphicsString & str, core::math::pt32i point) = 0;
        ...
        virtual core::math::si32i MeasureString(std::string str, graphics::text::font font) = 0;
    };
    ...
    public:
        ...
        virtual std::shared_ptr<graphics::IGraphicsPixmap> CreatePixmap(core::math::si32i) = 0;
