...
namespace ui
{
    ...
    {
        properties[u8"pos"] = make_accessor(static_cast<void (Control::*)(const core::pointf &) >(&Control::move), &Control::pos);
        properties[u8"size"] = make_accessor(static_cast<void (Control::*)(const core::vec2<core::dimenf> &) >(&Control::resize), &Control::size);

        properties[u8"border"] = make_accessor(&Control::setBorder, &Control::border);
        properties[u8"padding"] = make_accessor(&Control::setPadding, &Control::padding);
        properties[u8"margin"] = make_accessor(&Control::setMargin, &Control::margin);

        properties[u8"border-color"] = make_accessor(&Control::setBorderColors, &Control::borderColors);
        properties[u8"background-color"] = make_accessor(&Control::setBackgroundColor, &Control::backgroundColor);
    }
    ...
    void Control::updateStyle()
    {
        ...
        std::map<std::u8string, std::u8string> items = ss->generate(style);
        auto iter_transition_duration = items.find(u8"transition-duration");
    ...
    void Control::clearAnimations(const std::u8string & group)
    {
    ...
    void Control::appendAnimation(const std::u8string & group, std::shared_ptr<core::animation> animation)
    {
