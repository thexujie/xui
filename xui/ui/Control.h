...
namespace ui
{
    ...
    const std::u8string CONTROL_ANIMATION_GROUP_STYLE = u8"_style";
    const std::u8string CONTROL_ANIMATION_GROUP_CONTROL = u8"_control";
    ...
    public:
        ...
        virtual std::u8string styleName() const { return {}; }
    ...
    public:
        ...
        void appendAnimation(std::shared_ptr<core::animation> animation) { appendAnimation(std::u8string(), animation); }
        void appendAnimation(const std::u8string & group, std::shared_ptr<core::animation> animation);
