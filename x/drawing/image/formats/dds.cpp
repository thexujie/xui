...
namespace drawing::image::formats
{
    ...
    bool is_dds_data(const byte_t * buffer, size_t length)
    {
    ...
    static void bc3_calc_alpha(uint8_t alpha0, uint8_t alpha1, uint8_t alphas[8])
    {
        alphas[0] = alpha0;
        alphas[1] = alpha1;
    ...
    static void bc3_calc_alpha_indices(uint16_t index0, uint16_t index1, uint16_t index2, uint8_t indices[4][4])
    {
