...
namespace core
{
    ...
    size_t utf32_to_utf8(const char32_t & ch, char * text);
    int32_t utf32_to_utf16(const char32_t & ch, char16_t * text);
    size_t utf16_to_utf32(const char16_t * text, size_t size, char32_t & ch);
    size_t utf8_to_utf32(const char * text, size_t size, char32_t & ch);
}
